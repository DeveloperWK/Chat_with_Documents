...
### 1.1. Python (3.10 or higher recommended)
...
2. **Create a Virtual Environment (Recommended):** A virtual environment isolates your project's dependencies.
...
4. **Install Python Dependencies:**
    ...
    This command installs all dependencies listed in your `pyproject.toml` (or `requirements.txt`) in "editable" mode, which is convenient for development.
...
- **To reset the database** before adding new documents (e.g., if you've changed documents or want a fresh start):
    ...
    ```
    python main.py populate-db --reset
    ```
...
```
python main.py query "What is the main topic of the report?"
```
